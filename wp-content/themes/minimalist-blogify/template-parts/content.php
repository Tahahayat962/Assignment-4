		...
		<?php else : ?>
			...
			<div class="content-wrapper">
								...
								<div class='post-meta-inner-wrapper'>
									...
									<?php if (!$minimalistique_theme_hide_author_byline_name) : ?>
										<span class="post-author-data">
											<?php the_author(); ?><?php esc_html_e(', ', 'minimalist-blogify'); ?>
										<?php endif; ?>
				...
				<div class="entry-content">
					...
					<?php
					wp_link_pages(array(
						'before' => '<div class="page-links">' . esc_html__('Pages:', 'minimalist-blogify'),
						'after'  => '</div>',
					));
					?>
				...
				<?php if ($minimalistique_theme_is_related_posts || (CustomizerControls::GetSelectedOrDefault(CustomizerControls::BLOGFEED_SHOW_READMORE_BUTTON) == '1' && get_theme_mod('show_except_or_full') == '')) : ?>
					<a class="read-story" href="<?php the_permalink() ?>">
						<?php ($minimalistique_theme_is_related_posts ? esc_html_e('Read More', 'minimalist-blogify') : esc_html_e('Continue Reading', 'minimalist-blogify')); ?>
					</a>
				<?php endif; ?>
			</div>
