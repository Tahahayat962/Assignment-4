...
get_header(); ?>
<?php 
	$overall_blog_enable_single_featured_img = get_theme_mod( 'overall_blog_enable_single_featured_img', true );
	$overall_blog_enable_single_post_header_img = get_theme_mod( 'overall_blog_enable_single_post_header_image', false );
	$img = '';
	$header_image = get_header_image();
	$default_header_image = ! empty( $header_image ) ?  $header_image : get_template_directory_uri() . '/assets/img/header-image.jpg';
	if ( has_post_thumbnail() && $overall_blog_enable_single_featured_img ){
	...
	$post_header_disable_class='';
	if ($overall_blog_enable_single_post_header_img==false) {
		$post_header_disable_class='disable-top-header-image';	
	} 
?>
<div class="wrapper">
	<div id="banner-image" class="<?php echo $post_header_disable_class; ?>" style="background-image: url('<?php echo esc_url( $img ); ?>');">
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php
					$post_pagination_enable = get_theme_mod( 'overall_blog_enable_single_pagination', true );
